...
namespace SquashNiagara.Controllers
{
    public class DivisionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,PositionNo")] Division division)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,PositionNo")] Division division)
        {
            if (id != division.ID)
            {
                return NotFound();
