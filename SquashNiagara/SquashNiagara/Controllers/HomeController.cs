    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult Standings()
        {
            ...
            var playersByPosition =
               ...
               where f.SeasonID == 1 && f.DivisionID == 1 && f.HomeTeamScore != null /*&& pp.PositionID == currentPosition*/
            ...
            //get the total of fixtures by player
            //select count(*)
            //from SQUASH.Fixtures f
            //join SQUASH.Matches m
            //    on m.FixtureID = f.ID
            //where f.SeasonID = 1 and f.DivisionID = 1 and (m.HomePlayerID = 25 or m.AwayPlayerID = 25)


            ViewBag.positions = pos.ToList();
            ViewBag.playersByPosition = newPS;
            //ViewBag.playerPosition = playerPosition.ToList();
